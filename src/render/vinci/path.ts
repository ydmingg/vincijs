import type { Element, RendererDrawElementOptions, ViewContext2D, LinearGradientColor, RadialGradientColor } from '../../types';
import { rotateElement, generateSVGPath, calcViewElementSize } from '../../tools';
