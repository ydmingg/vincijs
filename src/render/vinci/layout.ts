import type { RendererDrawElementOptions, ViewContext2D, DataLayout, Element } from '../../types';
import { calcViewElementSize, calcViewBoxSize } from '../../tools';
...
export function drawLayout(ctx: ViewContext2D, layout: DataLayout, opts: RendererDrawElementOptions, renderContent: (ctx: ViewContext2D) => void) {
  ...
  const elem: Element = { id: 'layout', type: 'group', ...layout };
